# Form implementation generated from reading ui file 'C:\Users\tony\Desktop\eric\imagexif.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pbread = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.pbread.setEnabled(False)
        self.pbread.setObjectName("pbread")
        self.horizontalLayout_2.addWidget(self.pbread)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "图片EXIF"))
        self.lineEdit.setText(_translate("MainWindow", "图片EXIF信息"))
        self.pbselect.setText(_translate("MainWindow", "选择图片"))
        self.pbread.setText(_translate("MainWindow", "读取"))
        self.pbsave.setText(_translate("MainWindow", "保存"))
        self.pbreset.setText(_translate("MainWindow", "重置"))
        self.lineEdit_3.setText(_translate("MainWindow", "图片"))
        self.lineEdit_4.setText(_translate("MainWindow", "信息"))
